...
import com.iam.interfaces.rest.transform.RoleResourceFromEntityAssembler;
 ...
 */
@RestController
@RequestMapping(value = "/api/v1/authentication/roles", produces = MediaType.APPLICATION_JSON_VALUE)
